...
})}),define("taoRevision/controller/history/index",["jquery","i18n","tpl!taoRevision/controller/history/line","helpers","ui/feedback","select2","ui/tooltip"],function($,__,lineTpl,helpers,feedback){"use strict";var _restoreRevision=function(element){var $table=$("#revisions-table"),body=$table.find("tbody")[0],$this=$(element),revision=$this.data("revision"),id=$("#resource_id").val(),message=prompt("Please enter a message",__("Restored version %s",revision));"undefined"!=typeof revision&&"undefined"!=typeof message&&null!=message&&""!==revision&&""!==message&&$.post(helpers._url("restoreRevision","History","taoRevision"),{id:id,revisionId:revision,message:message
